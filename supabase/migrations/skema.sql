...
CREATE FUNCTION public.create_comment_like_notification() RETURNS trigger
...
CREATE FUNCTION public.create_or_get_chat_room(recipient_id uuid) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.create_repost_notification() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.get_follower_leaderboard() RETURNS TABLE(user_id uuid, name text, avatar_text text, role text, follower_count bigint)
...
CREATE FUNCTION public.get_followers_profiles(p_user_id uuid, p_limit integer DEFAULT 20, p_offset integer DEFAULT 0, p_search text DEFAULT NULL::text) RETURNS TABLE(id uuid, name text, avatar_text text, role text, created_at timestamp with time zone)
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
...
CREATE FUNCTION public.get_following_profiles(p_user_id uuid, p_limit integer DEFAULT 20, p_offset integer DEFAULT 0, p_search text DEFAULT NULL::text) RETURNS TABLE(id uuid, name text, avatar_text text, role text, created_at timestamp with time zone)
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  select p.id, p.name, p.avatar_text, p.role, uf.created_at
...
CREATE FUNCTION public.handle_new_chat_message_notification() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.handle_new_comment_notification() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.handle_new_follower_notification() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
CREATE FUNCTION public.handle_new_like_notification() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.handle_post_mentions_notification() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.is_username_available(desired text, exclude_user_id uuid DEFAULT NULL::uuid) RETURNS boolean
...
CREATE FUNCTION public.normalize_username(inp text) RETURNS text
...
CREATE FUNCTION public.repost_post(post_id_to_repost uuid) RETURNS void
    LANGUAGE plpgsql
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE FUNCTION public.slugify_username(inp text) RETURNS text
    LANGUAGE sql IMMUTABLE
    SET search_path TO 'pg_catalog', 'public'
    AS $$
...
CREATE FUNCTION public.slugify_username(p text, fallback text) RETURNS text
    LANGUAGE sql IMMUTABLE
    SET search_path TO 'pg_catalog', 'public'
    AS $$
  select case
...
CREATE FUNCTION public.update_room_last_message_at() RETURNS trigger
    LANGUAGE plpgsql
    SET search_path TO 'public'
    AS $$
BEGIN
...
CREATE FUNCTION public.update_room_last_message_at(room_id uuid, last_message_at timestamp with time zone) RETURNS void
    LANGUAGE plpgsql
    SET search_path TO 'public'
    AS $$
BEGIN
...
CREATE TRIGGER on_comment_like_delete AFTER DELETE ON public.comment_likes FOR EACH ROW EXECUTE FUNCTION public.update_comment_like_count();



CREATE TRIGGER on_comment_like_insert AFTER INSERT ON public.comment_likes FOR EACH ROW EXECUTE FUNCTION public.update_comment_like_count();



CREATE TRIGGER on_comment_like_notification AFTER INSERT ON public.comment_likes FOR EACH ROW EXECUTE FUNCTION public.create_comment_like_notification();



CREATE TRIGGER on_post_like_delete AFTER DELETE ON public.post_likes FOR EACH ROW EXECUTE FUNCTION public.update_post_like_count();



CREATE TRIGGER on_post_like_insert AFTER INSERT ON public.post_likes FOR EACH ROW EXECUTE FUNCTION public.update_post_like_count();



CREATE TRIGGER on_repost_notification AFTER INSERT ON public.posts FOR EACH ROW WHEN ((new.original_post_id IS NOT NULL)) EXECUTE FUNCTION public.create_repost_notification();



CREATE TRIGGER trg_profiles_normalize_username BEFORE INSERT OR UPDATE OF username ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.normalize_username();



CREATE TRIGGER trigger_comment_notification AFTER INSERT ON public.comments FOR EACH ROW EXECUTE FUNCTION public.handle_new_comment_notification();



CREATE TRIGGER trigger_like_notification AFTER INSERT ON public.post_likes FOR EACH ROW EXECUTE FUNCTION public.handle_new_like_notification();



CREATE TRIGGER trigger_new_chat_message_notification AFTER INSERT ON public.chat_messages FOR EACH ROW EXECUTE FUNCTION public.handle_new_chat_message_notification();



CREATE TRIGGER trigger_new_follower AFTER INSERT ON public.user_followers FOR EACH ROW EXECUTE FUNCTION public.handle_new_follower_notification();



CREATE TRIGGER trigger_new_mentions AFTER INSERT ON public.posts FOR EACH ROW EXECUTE FUNCTION public.handle_post_mentions_notification();



CREATE TRIGGER update_chat_room_last_message_at AFTER INSERT ON public.chat_messages FOR EACH ROW EXECUTE FUNCTION public.update_room_last_message_at();



CREATE TRIGGER update_comments_count AFTER INSERT OR DELETE ON public.comments FOR EACH ROW EXECUTE FUNCTION public.update_post_counts();
