...
const ChatPage = () => {
  ...
  if (!roomId) return <div>Room ID tidak ditemukan.</div>;
      ...
      <div className="flex flex-col h-[calc(100vh-2rem)] max-h-[850px] w-full max-w-[500px] overflow-hidden rounded-xl bg-background shadow-2xl border">
        ...
        >
          <div className="p-4 space-y-2">
            ...
            />
            {isFetchingNextPage && <p className="text-sm text-center text-muted-foreground py-2">Memuat pesan lama...</p>}
                  ...
                  >
                      ...
                      <Avatar className={`h-6 w-6 flex-shrink-0 ${
                          ...
                          <AvatarFallback className="text-xs bg-primary text-primary-foreground">
                            {(senderProfile?.avatar_text || '?').substring(0, 2)}
                          </AvatarFallback>
                      </Avatar>
                      )}
